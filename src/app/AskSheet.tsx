...
import { composeMessage, QUICK_QUESTIONS, removePick, whatsappFor, type Pick } from "@/lib/picks";
      ...
      <div className="ask__panel" role="dialog" aria-modal="true" aria-label="Ask Osama" ref={panel}>
        ...
        {picks.length ? (
          <div className="ask__picks">
            ...
            <a className="ask__send" href={whatsappFor(text)} target="_blank" rel="noopener noreferrer" onClick={onClose}>Send it on WhatsApp</a>
          </div>
        ) : null}
        ...
        <p className="ask__foot">Tap a site or a course anywhere on the site and it joins your message. Courses and dives are arranged through CDWS-registered dive centres in Dahab.</p>
