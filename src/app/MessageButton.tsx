...
export default function MessageButton() {
  ...
  return (
    <a className={`msgbtn${away ? " is-away" : ""}`} href={WHATSAPP} target="_blank" rel="noopener noreferrer" aria-label="Message Osama on WhatsApp" data-analytics-event="whatsapp_click" data-analytics-category="conversion" data-analytics-label="Message Osama">
