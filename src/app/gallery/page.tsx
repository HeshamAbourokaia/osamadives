  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-xl bg-gray-100 shadow-sm hover:shadow-xl transition-shadow duration-300">
        ...
        {photo.featured && (
          <div className="absolute top-3 right-3 bg-[#0a7d70] text-white text-xs font-bold px-2 py-1 rounded">
            FEATURED
          </div>
        )}
        {photo.story && (
    ...
    <DescentShell>
        ...
        <div className="max-w-6xl mx-auto text-center text-white">
          ...
          <div className="flex justify-center gap-4">
            ...
            >
              ...
              <span className="only-desktop">View More on Facebook</span>
              <span className="only-mobile">Facebook</span>
            </a>
            <a
              href={INSTAGRAM_URL}
              target="_blank"
            ...
            >
              ...
              <span className="only-desktop">Follow on Instagram</span>
              <span className="only-mobile">Instagram</span>
            </a>
          </div>
        </div>
      </header>
      ...
      <main id="gallery-content" className="py-12 px-4">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="inline-flex bg-gray-100 rounded-full p-1">
              <button
                ...
                className={`px-6 py-2 rounded-full text-sm font-medium transition-all ${
                  activeTab === "photos"
                    ? "bg-[#0a7d70] text-white shadow-md"
          ...
          <AlbumSheet
            albums={[
              ...
              ...categories.map((category) => ({
                ...
                count: galleryPhotos.filter((p) => p.category === category).length,
              })),
            ]}
            active={selectedCategory}
            onPick={setSelectedCategory}
          />
          <div className="only-desktop flex flex-wrap justify-center gap-2 mb-8">
            <button
              onClick={() => setSelectedCategory("all")}
              className={`px-4 py-2 rounded-full text-sm font-medium transition ${
                selectedCategory === "all"
                  ? "bg-[#0a7d70] text-white"
          ...
          {/* Photo Counter */}
          <div className="only-desktop text-center mb-6">
            <p className="text-sm text-gray-500">
              ...
              {selectedCategory !== "all" && (
                <span>
                  {" "}
                  in{" "}
                  <span className="font-semibold text-[#0a7d70]">
          ...
          <div className="mt-12 text-center">
            <div className="bg-gradient-to-r from-[#0a7d70]/10 via-[#0a7d70]/5 to-[#0a7d70]/10 rounded-2xl p-8">
