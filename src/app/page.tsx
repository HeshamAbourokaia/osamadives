      ...
      <main id="descent-main">
        ...
        <section className="g-abyss brand-act" id="brand-act">
          <div className="brand-stage">
            <img className="brand-stage__photo" data-sc-parallax="-0.12" src="/images/osama-brand-hero.webp" srcSet="/images/osama-brand-hero-m.webp 800w, /images/osama-brand-hero.webp 1600w" sizes="(max-width: 860px) 180vh, 100vw" fetchPriority="high" alt="Osama teaching a diving student in the crystal-clear shallow water of Dahab, Egypt" />
