...
export const galleryPhotos: GalleryPhoto[] = [
  ...
  },
  {
    ...
    alt: 'A young diver being geared up with a scuba tank on the Dahab promenade, other children in wetsuits waiting nearby',
    title: 'Training the Next Generation',
    description: 'A young diver getting geared up on the Dahab promenade, the tank almost as big as he is. Children learn fast here. Growing up in Dahab, the sea is simply part of the day.',
    location: 'Dahab, Egypt',
    coordinates: { lat: 28.5000, lng: 34.5167 },
    featured: true,
    category: 'stories',
    tags: ['abdullah', 'son', 'family', 'kids', 'teaching', 'dahab', 'story', 'next-generation'],
    story: 'A young diver getting geared up on the Dahab promenade, the tank almost as big as he is. Children learn fast here. Growing up in Dahab, the sea is simply part of the day.'
  },
  {
  ...
  },
  {
    ...
    description: 'A gorgonian fan coral wide enough to hide the diver behind it. Fans this size grow slowly in the current over decades. I bring divers here and ask them to hover and look.',
    location: 'Dahab, Red Sea',
    coordinates: { lat: 28.5000, lng: 34.5167 },
    category: 'stories',
    tags: ['coral', 'gorgonian', 'underwater', 'story'],
    story: 'A gorgonian fan coral wide enough to hide the diver behind it. Fans this size grow slowly in the current over decades. I bring divers here and ask them to hover and look.'
  },
  {
  ...
  },
  {
    ...
    title: 'The Canyon',
    description: 'Midday light through the Canyon. Knowing where to pause makes the difference: there is a crevice full of glassfish that most divers swim straight past.',
  ...
  },
  {
    ...
    description: 'A diver in the narrow passage of the Canyon. Underwater you talk with your eyes and your hands, and you trust the person leading you.',
    location: 'The Canyon, Dahab',
    coordinates: { lat: 28.4847, lng: 34.5189 },
    category: 'dive-sites',
  ...
  },
  {
    ...
    description: 'A technical diver carrying seven tanks: trimix, stages, deco bottles. This is the deep side of Dahab, and it starts with a careful plan on the sand.',
    location: 'Dahab, Egypt',
    coordinates: { lat: 28.5000, lng: 34.5167 },
    category: 'diving',
  ...
  // === NEW GALLERY IMAGES - DIVING ===
  {
    ...
    title: 'The Freediver in the Canyon',
    description: 'A freediver at the bottom of the Canyon, arms out between the walls with the sun pouring in. I met him down there on one of my dives: one breath, no tank, completely calm.',
    location: 'The Canyon, Dahab',
    coordinates: { lat: 28.4847, lng: 34.5189 },
    featured: true,
    category: 'diving',
  ...
  },
  {
    ...
    title: 'Over the Reef',
    description: 'A diver hovering over the reef in the blue of Dahab. This is what a good visibility day looks like here.',
    location: 'Dahab, Red Sea',
    coordinates: { lat: 28.5000, lng: 34.5167 },
    category: 'diving',
  ...
  },
  {
    ...
    title: 'Welcome to the Canyon',
    description: 'A diver kneeling on the floor of the Canyon, arms wide, with the blue glow of the gap above and another diver waiting up there.',
    location: 'The Canyon, Dahab',
    coordinates: { lat: 28.4847, lng: 34.5189 },
    featured: true,
    category: 'diving',
  ...
  },
  {
    ...
    description: 'You cannot plan these moments. An eagle ray appeared and swam beside the diver. The white spots on the wings, the glide without a single movement.',
    location: 'Dahab, Red Sea',
    coordinates: { lat: 28.5000, lng: 34.5167 },
    featured: true,
    category: 'diving',
  ...
  },
  {
    ...
    description: 'A green turtle swimming straight into a birthday photo. You cannot make this up.',
    location: 'Dahab, Red Sea',
    coordinates: { lat: 28.5000, lng: 34.5167 },
    featured: true,
    category: 'diving',
  ...
  },
  {
    ...
    description: 'The floor of the Canyon from another angle. The blue glow is the light filtering through the narrow gap above, with a diver floating up there for scale.',
    location: 'The Canyon, Dahab',
    coordinates: { lat: 28.4847, lng: 34.5189 },
    category: 'diving',
    tags: ['canyon', 'cressi', 'osama']
  },
  {
    ...
    description: 'Double shaka in the shallows, the shadow of the diver sharp on the sand. The water is that clear on a Dahab day.',
    location: 'Dahab, Red Sea',
    coordinates: { lat: 28.5000, lng: 34.5167 },
    category: 'diving',
  ...
  },
  {
    ...
    alt: 'Two divers outside a dive centre, one in full technical gear giving a thumbs up, the other in a t-shirt',
    title: 'Two Divers, One Dive Centre',
    description: 'Two divers outside the dive centre, one in full technical gear, the other relaxed in a t-shirt. Both kinds of day happen here.',
    location: 'Dahab, Egypt',
    coordinates: { lat: 28.5000, lng: 34.5167 },
    date: '2021-11-28',
    category: 'team',
    tags: ['nuno-gomes', 'world-record', 'friends', 'gear', 'dive-center', 'legend'],
    story: 'Two divers outside the dive centre, one in full technical gear, the other relaxed in a t-shirt. Both kinds of day happen here.'
  },
  {
  ...
  },
  {
    ...
    alt: 'Two people at a table at Shark Restaurant in Dahab with a large shrimp platter, fish murals on the wall',
    title: 'Dinner at Shark Restaurant',
    description: 'Dinner at Shark Restaurant, the restaurant of my family in Dahab, after a day in the water. The table is where every dive ends.',
    location: 'Shark Restaurant, Dahab, Egypt',
    coordinates: { lat: 28.5000, lng: 34.5167 },
    date: '2021-12-04',
    category: 'dahab',
    tags: ['food', 'restaurant', 'seafood', 'nuno-gomes', 'world-record', 'legend'],
    story: 'Dinner at Shark Restaurant, the restaurant of my family in Dahab, after a day in the water. The table is where every dive ends.'
  },
  {
